...
import com.example.xiudd.sese.presenter.HotVideoPresenter;
...
public class HotVideoActivity extends BaseActivity implements HotVideoContract.View {
    ...
    SmartRefreshLayout slHotVideo;
    private HotVideoPresenter hotVideoPresenter = new HotVideoPresenter(this);
    ...
    public void initView() {
        ...
        ryForeign.setLayoutManager(new LinearLayoutManager(HotVideoActivity.this));
        slHotVideo.autoRefresh();
        initToolBar().setToolbarBackIco().setToolbarTitle("热门视频");
        ...
        list.add("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1539755425221&di=c5ab59282e280ba0d658fa8247a27a55&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F01106257b673380000018c1bdeb3b6.jpg%40900w_1l_2o_100sh.jpg");
        list.add("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1539755425221&di=c5ab59282e280ba0d658fa8247a27a55&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F01106257b673380000018c1bdeb3b6.jpg%40900w_1l_2o_100sh.jpg");
        ivBanner.setDelayedTime(5000);
        ivBanner.setIndicatorVisible(true);
        ivBanner.setPages(list, new MZHolderCreator() {
            @Override
    ...
    public void initData() {
        slHotVideo.setOnRefreshListener(new OnRefreshListener() {
            @Override
            public void onRefresh(RefreshLayout refreshLayout) {
                hotVideoPresenter.setHotVideo();
                slHotVideo.finishRefresh(200);
            }
        });
        hotVideoPresenter.setHotVideo();
    }
    ...
    @Override
    public void loadHotVideo(List<HotVideoGson> gsons) {
        ryForeign.setNestedScrollingEnabled(false);
        HotVideoAdapter hotVideoAdapter = new HotVideoAdapter(HotVideoActivity.this, gsons);
    ...
    private class HotVideoAdapter extends BaseQuickAdapter<HotVideoGson, BaseViewHolder> {
        private Context context;

        public HotVideoAdapter(Context context, @Nullable List<HotVideoGson> data) {
            super(R.layout.ry_hot_video_item, data);
            this.context = context;
        }

        @Override
        protected void convert(BaseViewHolder helper, final HotVideoGson item) {
