...
import com.example.xiudd.sese.presenter.CartoonPresenter;
...
public class CartoonActivity extends BaseActivity implements CartoonContract.View {
    ...
    private CartoonPresenter presenter = new CartoonPresenter(this);
    ...
    public void initView() {
        ...
        ryForeign.setLayoutManager(new LinearLayoutManager(CartoonActivity.this));
        initToolBar().setToolbarBackIco().setToolbarTitle("成人动漫");
    }

    @Override
    public void initData() {
        presenter.setCartoonVideo();
    ...
    @Override
    public void loadCartoonVideo(List<HotVideoGson> gsons) {
        ryForeign.setNestedScrollingEnabled(false);
        ForeignVideoAdapter adapter = new ForeignVideoAdapter(CartoonActivity.this, gsons);
        ryForeign.setAdapter(adapter);
    }

    private class ForeignVideoAdapter extends BaseQuickAdapter<HotVideoGson, BaseViewHolder> {
        private Context context;

        public ForeignVideoAdapter(Context context, @Nullable List<HotVideoGson> data) {
