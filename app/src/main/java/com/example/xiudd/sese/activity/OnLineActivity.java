...
import com.example.xiudd.sese.presenter.OnlinePresenter;
...
public class OnLineActivity extends BaseActivity implements OnlineContract.View {
    ...
    private OnlinePresenter presenter = new OnlinePresenter(this);
    ...
    public void initView() {
        ...
        ryForeign.setLayoutManager(new LinearLayoutManager(OnLineActivity.this));
    ...
    public void loadCartoonVideo(List<HotVideoGson> gsons) {
        ...
        ForeignVideoAdapter adapter = new ForeignVideoAdapter(OnLineActivity.this, gsons);
